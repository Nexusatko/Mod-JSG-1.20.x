...
public class DHDMilkyWayButtonsConsoleItem extends DHDAbstractPartItem {
    public DHDMilkyWayButtonsConsoleItem(Properties properties, boolean mandatory, int raycasterId) {
        super(properties, mandatory, raycasterId);
    }

    public DHDMilkyWayButtonsConsoleItem(Properties properties, RegistryObject<CreativeModeTab> tab, boolean mandatory, int raycasterId) {
        super(properties, tab, mandatory, raycasterId);
    }
