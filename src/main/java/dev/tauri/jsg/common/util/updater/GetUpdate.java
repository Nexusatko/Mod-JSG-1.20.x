package dev.tauri.jsg.common.util.updater;
...
public class GetUpdate {
    ...
    public static UpdateResult checkForUpdate() {
        String currentVersion = JSG.MOD_VERSION.replace(JSG.MC_VERSION + "-", "").toLowerCase().split("-")[0].replaceAll("-", "").replaceAll("alpha", "").replaceAll("beta", "");
